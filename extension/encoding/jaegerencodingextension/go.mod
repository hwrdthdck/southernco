...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding v0.118.0
	...
	go.opentelemetry.io/collector/extension/extensiontest v0.118.1-0.20250203014413-643a35ffbcea
